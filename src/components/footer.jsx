...
class Globalfooter extends Component {
  render() {
    ...
    for (var i in this.props.initObj.footer.links){
      ...
      // Add keys to silence non-unique children warnings
    ...
    for (var i in this.props.initObj.footer.logos){
        ...
        logoImages.push(<img src={process.env.PUBLIC_URL + url} key={"img_" + url} style={{width:"150px", margin:"0px 20px 0px 0px"}}/>);
    }
